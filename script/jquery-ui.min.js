...
(function(t) {
    ...
    t.effects.define("bounce", function(e, i) {
        var s, n, o, a = t(this), r = e.mode, l = "hide" === r, h = "show" === r, c = e.direction || "up", u = e.distance, d = e.times || 5, p = 2 * d + (h || l ? 1 : 0), f = e.duration / p, m = e.easing, g = "up" === c || "down" === c ? "top" : "left", _ = "up" === c || "left" === c, v = 0, b = a.queue().length;
        ...
        n[g] = o,
        a.css("opacity", 0).css(g, _ ? 2 * -u : 2 * u).animate(n, f, m)),
        l && (u /= Math.pow(2, d - 1)),
        n = {},
        n[g] = o; d > v; v++)
            s = {},
    ...
    t.effects.define("explode", "hide", function(e, i) {
        ...
        var o, a, r, l, h, c, u = e.pieces ? Math.round(Math.sqrt(e.pieces)) : 3, d = u, p = t(this), f = e.mode, m = "show" === f, g = p.show().css("visibility", "hidden").offset(), _ = Math.ceil(p.outerWidth() / d), v = Math.ceil(p.outerHeight() / u), b = [];
        for (o = 0; u > o; o++)
            for (l = g.top + o * v,
            c = o - (u - 1) / 2,
            a = 0; d > a; a++)
